...
[^4]: Prior to 2021, I found one online recruitment brochure intent on recruiting veterans to serve as election workers [@studentveteransofamerica2020].
...
To test the theory that publicized efforts to recruit veterans to work as election staff and volunteers would ease election anxieties, a recent survey experiment was embedded in a survey developed and conducted by the Center for Democracy and Civic Engagement (CDCE) at the University of Maryland (UMD). The survey was fielded from August 29th, 2024 to September 18th, 2024 on a non-probability sample of 1,287 U.S. citizens 18 years of age or older. Survey participants were randomly assigned to read one of two fabricated news articles (i.e., vignettes) about recruitment efforts for election jobs.

Participants read either a treatment or control vignette, which was a fabricated news article about efforts in Maricopa County, AZ to recruit election staff and volunteers for the 2024 general election. The vignettes were identical save for mention of the group targeted for election work recruitment efforts. The treatment vignette focused on the announcement of a program by county election officials designed to recruit military veterans and their family members from the community, whereas the control vignette omitted mention of "military veterans and their family members", leaving in place "members of the community"[^6]. It should be noted that Maricopa County, AZ was chosen as the setting of the story in the vignettes due to the increased scrutiny levied toward election administration there after the 2020 election [@giles2021; @maricopacountyelectionsdepartment2022]. In addition, the survey includes a series of items which ask specifically about Maricopa County, AZ and a comparable series of questions about one's local area[^7].

[^6]: Complete text of treatment and control vignettes are included in the Appendix

[^7]: The setting of the vignettes and inclusion of duplicate questions in the survey are highlighted and discussed later as a potential limitation.

Over the past two decades it became commonplace for national polls to gauge public confidence in election administration by asking some variety of the question, "How confident are you that your vote [will be/was] counted as you intended in the most recent election?" [@hall2009; @sances2015; @stewart2022]. In addition, since 2008, the Survey of the Performance of American Elections (SPAE) has included a good number of relevant questions to more thoroughly assess trust and confidence in election administration. Such questions inquire into the voter experience with the institution more directly. This study borrows, modifies, or takes inspiration from certain questions found within the 2022 SPAE and other survey items used by the Pew Research Center [@dunn2018]. These survey items comprise the dependent variables[^8].

[^8]: All survey items are included in the Appendix. 

The outcomes of interest (i.e., dependent variables) are broadly referred to as *election anxieties*, but more specifically refer to concern over fairness and accuracy of the election administration; expectations of fraudulent activity intent on manipulating the electoral outcomes; and concern for voter safety, i.e., comfort voting in-person as it relates to expectations of violence, threats, or intimidation.

The first outcome of interest regards trust and confidence in the electoral process, which refers to trust and confidence in the integrity and security of the electoral systems, administration, technology, and people or organizations to fairly and accurately conduct elections. Survey items  measured the degree of confidence that votes will be counted as voters intend, confidence that electoral systems are secure from technological threats. The first hypothesis is as follows: 

::: {#hyp-1}

### Hypothesis 1

Trust and confidence in election administration will be higher among those who were presented information about efforts to recruit veterans as election workers compared to those who were not

:::

Survey participants also responded to questions asking about expectations of fraudulent activity intent on manipulating the electoral outcome. 


The second outcome of interest regards an individual's personal safety concerns about the prospect of voting in-person at a polling site. That is, the extent people feel safe enough to cast a vote at polling sites free from violence, threats of violence, or intimidation.

The primary independent variable is the prospect of military veterans as poll workers. It was considered that veterans would elicit high degrees of approval and support for whatever cause or issue presented. For example, I'd expect high approval and support for recruiting veterans to baseball teams just as much as for recruiting them to work as election staff. Asking participants whether they supported programs intent on recruiting veterans to work as election staff would garner support regardless of the target group. Considering that support and admiration for veterans is generally high among the population [@kleykamp2023], then discerning the impact on one's confidence would require survey questions designed to determine whether veterans have any special effect on electoral confidence and voter safety distinct from the generally high admiration observed most often.



The literature concerning public regard for veterans gives substantial reason to expect that publicized efforts to recruit veterans to work as election staff and volunteers would have the effect of easing election anxieties. 




This is a one-sided directional hypothesis. Previous research on public perception and regard for U.S. military veterans gives credence to the directional hypothesis [@kleykamp2018; @kleykamp2023].
...
Simply put, anything special about veterans that influences people's trust and confidence in election administration is expected to be observable in participants' survey responses. However, exactly what makes veterans special in this regard will not; this study did not inquire into details of public perception about veterans specifically (e.g., positive stereotypes, typical characteristics). 
...
The goal was to determine whether there is anything special in having veterans volunteer as election staff (i.e., poll workers). That is, does it make any difference in terms of concerns over election security, fairness, and voter safety to include veterans as election staff and volunteers compared to other groups? The extent people believe veterans are more trustworthy as election workers than non-veterans in general is difficult without comparable groups to consider.


A series of survey questions sought to determine whether support for veterans as election staff would be notably higher when compared to other relatively neutral groups.   


It was hypothesized that different versions of statements in a series of survey questions would result in consistent response effects.  
...
-   limitations: interpretations of the treatment effect are limited.
  ...
  -   Moreover, results are limited by the survey questions, questionnaire design, and experimental stimulus (i.e., vignette) for two reasons. 
...
::::: {#fig-vignettes layout-ncol=2 .content-hidden unless-format="pdf"}
::: {#fig-treatment}
### Treatment Vignette
