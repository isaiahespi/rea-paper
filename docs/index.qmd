...
options(tinytable_html_mathjax = TRUE) # set option to render math in html

# apply Quarto data processing to all tables
...
::: {.content-visible when-format="bookup-html" unless-format="pdf"}
...
::: {.content-visible when-format="pdf" unless-format="bookup-html"}
...
texreg::texreg(
  ...
  caption.above = T,
  use.packages = F,
  table = F, # set `table = FALSE`. Quarto handles table cross-ref env
  custom.model.names = c("Confidence in AZ Elections", "w/Interaction"),
  custom.coef.names = c(
    "(Intercept)",
    "Treatment",
